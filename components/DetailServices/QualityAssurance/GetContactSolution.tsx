                    ...
                    <Form className="space-y-8 text-white">
                        <motion.div variants={fadeInUp}>
                            <Card className="bg-transparent border border-gray-300">
                                <CardHeader>
                                    <CardTitle className="text-white">1. Platform</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="flex flex-wrap gap-4">
                                        {['Web', 'Mobile', 'Desktop', 'IoT', 'Cloud'].map((item) => (
                                            <motion.div key={item} className="flex items-center" whileHover={{ scale: 1.05 }}>
                                                ...
                                                />
                                                <label htmlFor={`platform-${item}`} className="ml-2 text-sm font-medium  text-white">
                                                    {item}
                                                </label>
                                            </motion.div>
                                        ))}
                        ...
                        <motion.div variants={fadeInUp}>
                            <Card className="bg-transparent border border-gray-300">
                                <CardHeader>
                                    <CardTitle className="text-white">2. Service</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="flex flex-wrap gap-4">
                                        {['Test Automation', 'Test Management', 'Consulting and Audit', 'Team Augmentation', 'Performance Testing', 'Security Testing'].map((item) => (
                                            <motion.div key={item} className="flex items-center" whileHover={{ scale: 1.05 }}>
                                                ...
                                                />
                                                <label htmlFor={`service-${item}`} className="ml-2 text-sm font-medium  text-white">
                                                    {item}
                                                </label>
                                            </motion.div>
                                        ))}
                        ...
                        <motion.div variants={fadeInUp}>
                            <Card className="bg-transparent border border-gray-300">
                                <CardHeader>
                                    <CardTitle className="text-white">3. Specialists</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {Object.entries(values.specialists).map(([key, value]) => (
                                            <motion.div key={key} className="flex items-center justify-between" whileHover={{ scale: 1.05 }}>
                                                <span className="text-sm font-medium  text-white">{key.replace(/([A-Z])/g, ' $1').trim()}:</span>
                        ...
                        <motion.div variants={fadeInUp}>
                            <Card className="bg-transparent border border-gray-300">
                                <CardHeader>
                                    <CardTitle className="text-white">4. Duration</CardTitle>
                                </CardHeader>
                                <CardContent>
                                    <Slider
                                        min={1}
                                        ...
                                        className="w-full"
                                    />
                                    <div className="flex justify-between mt-2 text-xs sm:text-sm text-muted-foreground text-white">
                                        <span>1 month</span>
                                        <span>6 months</span>
                                        <span>1 year</span>
                                        <span>1.5 years</span>
                        ...
                        <motion.div variants={fadeInUp}>
                            <Button
                                type="submit"
                                className="w-full bg-[#6430c2] hover:bg-[#6430c2]/90 text-primary-foreground font-bold py-3 rounded-lg"
