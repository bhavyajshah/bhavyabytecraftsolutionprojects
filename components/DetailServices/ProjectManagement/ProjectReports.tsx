...
export default function Component() {
  return (
    <div className="min-h-screen dark:bg-transparent text-gray-800 dark:text-white p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          <Card className="bg-white dark:bg-transparent border-gray-200 dark:border-gray-700">
            ...
            <CardContent className="flex flex-col items-center">
              <p className="text-4xl font-bold mb-2">{projectData.projectMetrics.clientSatisfaction}/5</p>
            ...
            <CardContent>
              <p className="text-center mb-2">Velocity Trend</p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          {projectData.sprints.map((sprint) => (
              <Card key={sprint.id} className="bg-white dark:bg-transparent border-gray-200 dark:border-gray-700">
              ...
              <CardContent>
                <div className="flex justify-between items-center mb-4">
                  <div>
                    <p className="text-4xl font-bold">{sprint.tasksCompleted}%</p>
                    <p className="text-sm text-gray-500 dark:text-gray-300">Tasks Completed</p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-300">Completed scope</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-300">Committed scope</p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <Card className="bg-white dark:bg-transparent border-gray-200 dark:border-gray-700">
          <CardHeader>
            <CardTitle className="text-xl">Sprint Performance Overview</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-8 lg:mt-20 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-4">
              ...
              <CardContent>
                <p className="text-3xl font-bold text-green-600 dark:text-green-400">{projectData.projectMetrics.costSavings}%</p>
                <p className="text-sm text-gray-500 dark:text-gray-300">Average project cost reduction</p>
              </CardContent>
            </Card>
                      <Card className="bg-white dark:bg-transparent border-gray-200 dark:border-gray-700">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">{projectData.projectMetrics.qualityScore}/100</p>
                <p className="text-sm text-gray-500 dark:text-gray-300">Average quality score</p>
              </CardContent>
            </Card>
          </div>
        </div>
